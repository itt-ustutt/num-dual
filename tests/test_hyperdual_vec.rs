...
fn test_hyperdual_vec_recip() {
    let res = HyperDualVec64::<2, 2>::new(
        ...
        RowSVector::from([1.0, 1.0]),
        SMatrix::from([[0.0, 0.0], [0.0, 0.0]]),
    )
    .recip();
    ...
    assert!((res.eps2[1] - -0.694444444444445).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 1.15740740740741).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 1.15740740740741).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 1.15740740740741).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 1.15740740740741).abs() < 1e-12);
}
...
fn test_hyperdual_vec_exp() {
    ...
    assert!((res.eps2[1] - 3.32011692273655).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 3.32011692273655).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 3.32011692273655).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 3.32011692273655).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 3.32011692273655).abs() < 1e-12);
}
...
fn test_hyperdual_vec_exp2() {
    ...
    assert!((res.eps2[1] - 1.59243405216008).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 1.10379117348241).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 1.10379117348241).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 1.10379117348241).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 1.10379117348241).abs() < 1e-12);
}
...
fn test_hyperdual_vec_ln() {
    ...
    assert!((res.eps2[1] - 0.833333333333333).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.694444444444445).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.694444444444445).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.694444444444445).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.694444444444445).abs() < 1e-12);
}
...
fn test_hyperdual_vec_log() {
    ...
    assert!((res.eps2[1] - 0.580685888982970).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.483904907485808).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.483904907485808).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.483904907485808).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.483904907485808).abs() < 1e-12);
}
...
fn test_hyperdual_vec_ln_1p() {
    ...
    assert!((res.eps2[1] - 0.454545454545455).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.206611570247934).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.206611570247934).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.206611570247934).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.206611570247934).abs() < 1e-12);
}
...
fn test_hyperdual_vec_log2() {
    ...
    assert!((res.eps2[1] - 1.20224586740747).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -1.00187155617289).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -1.00187155617289).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -1.00187155617289).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -1.00187155617289).abs() < 1e-12);
}
...
fn test_hyperdual_vec_log10() {
    ...
    assert!((res.eps2[1] - 0.361912068252710).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.301593390210592).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.301593390210592).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.301593390210592).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.301593390210592).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sqrt() {
    ...
    assert!((res.eps2[1] - 0.456435464587638).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.190181443578183).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.190181443578183).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.190181443578183).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.190181443578183).abs() < 1e-12);
}
...
fn test_hyperdual_vec_cbrt() {
    ...
    assert!((res.eps2[1] - 0.295182935884059).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.163990519935588).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.163990519935588).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.163990519935588).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.163990519935588).abs() < 1e-12);
}
...
fn test_hyperdual_vec_powf() {
    ...
    assert!((res.eps2[1] - 7.52712759108966).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 20.0723402429058).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 20.0723402429058).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 20.0723402429058).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 20.0723402429058).abs() < 1e-12);
}
...
fn test_hyperdual_vec_powf_0() {
    ...
    assert!((res.eps2[1]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)]).abs() < 1e-12);
}
...
fn test_hyperdual_vec_powf_1() {
    ...
    assert!((res.eps2[1] - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)]).abs() < 1e-12);
...
fn test_hyperdual_vec_powf_2() {
    ...
    assert!((res.eps1eps2[(0, 1)] - 2.00000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 2.00000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 2.00000000000000).abs() < 1e-12);
}
...
fn test_hyperdual_vec_powi() {
    ...
    assert!((res.eps2[1] - 14.9299200000000).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 62.2080000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 62.2080000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 62.2080000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 62.2080000000000).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sin() {
    ...
    assert!((res.eps2[1] - 0.362357754476674).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.932039085967226).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.932039085967226).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.932039085967226).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.932039085967226).abs() < 1e-12);
}
...
fn test_hyperdual_vec_cos() {
    ...
    assert!((res.eps2[1] - -0.932039085967226).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.362357754476674).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.362357754476674).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.362357754476674).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.362357754476674).abs() < 1e-12);
}
...
fn test_hyperdual_vec_tan() {
    ...
    assert!((res.eps2[1] - 7.61596396720705).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 39.1788281446144).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 39.1788281446144).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 39.1788281446144).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 39.1788281446144).abs() < 1e-12);
}
...
fn test_hyperdual_vec_asin() {
    ...
    assert!((res.eps2[1] - 1.02062072615966).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 0.212629317949929).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 0.212629317949929).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 0.212629317949929).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 0.212629317949929).abs() < 1e-12);
}
...
fn test_hyperdual_vec_atan() {
    ...
    assert!((res.eps2[1] - 0.961538461538462).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.369822485207101).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.369822485207101).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.369822485207101).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.369822485207101).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sinh() {
    ...
    assert!((res.eps2[1] - 1.81065556732437).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 1.50946135541217).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 1.50946135541217).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 1.50946135541217).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 1.50946135541217).abs() < 1e-12);
}
...
fn test_hyperdual_vec_cosh() {
    ...
    assert!((res.eps2[1] - 1.50946135541217).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 1.81065556732437).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 1.81065556732437).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 1.81065556732437).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 1.81065556732437).abs() < 1e-12);
}
...
fn test_hyperdual_vec_tanh() {
    ...
    assert!((res.eps2[1] - 0.305019996207409).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.508562650138273).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.508562650138273).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.508562650138273).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.508562650138273).abs() < 1e-12);
}
...
fn test_hyperdual_vec_asinh() {
    ...
    assert!((res.eps2[1] - 0.640184399664480).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.314844786720236).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.314844786720236).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.314844786720236).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.314844786720236).abs() < 1e-12);
}
...
fn test_hyperdual_vec_acosh() {
    ...
    assert!((res.eps2[1] - 1.50755672288882).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -4.11151833515132).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -4.11151833515132).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -4.11151833515132).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -4.11151833515132).abs() < 1e-12);
}
...
fn test_hyperdual_vec_atanh() {
    ...
    assert!((res.eps2[1] - 1.04166666666667).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 0.434027777777778).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 0.434027777777778).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 0.434027777777778).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 0.434027777777778).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sph_j0() {
    ...
    assert!((res.eps2[1] - -0.345284569857790).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.201224955209705).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.201224955209705).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.201224955209705).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.201224955209705).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sph_j1() {
    ...
    assert!((res.eps2[1] - 0.201224955209705).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.201097592627034).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.201097592627034).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.201097592627034).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.201097592627034).abs() < 1e-12);
}
...
fn test_hyperdual_vec_sph_j2() {
    ...
    assert!((res.eps2[1] - 0.129004104011656).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 0.0589484167190109).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 0.0589484167190109).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 0.0589484167190109).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 0.0589484167190109).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j0_0() {
    ...
    assert!((res.eps1eps2[(0, 1)] - -0.500000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.500000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.500000000000000).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j1_0() {
    ...
    assert!((res.eps2[1] - 0.500000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)]).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)]).abs() < 1e-12);
...
fn test_hyperdual_vec_bessel_j2_0() {
    ...
    assert!((res.eps1eps2[(0, 1)] - 0.250000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 0.250000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 0.250000000000000).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j0_1() {
    ...
    assert!((res.eps2[1] - -0.498289057567215).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.255891862958350).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.255891862958350).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.255891862958350).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.255891862958350).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j1_1() {
    ...
    assert!((res.eps2[1] - 0.255891862958350).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.365498208944163).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.365498208944163).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.365498208944163).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.365498208944163).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j2_1() {
    ...
    assert!((res.eps2[1] - 0.232707360321110).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 0.0893643434615870).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 0.0893643434615870).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - 0.0893643434615870).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - 0.0893643434615870).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j0_2() {
    ...
    assert!((res.eps2[1] - -0.0543274202223671).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.287525216370074).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.287525216370074).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.287525216370074).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.287525216370074).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j1_2() {
    ...
    assert!((res.eps2[1] - 0.287525216370074).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - -0.0932134954083656).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - -0.0932134954083656).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 0)] - -0.0932134954083656).abs() < 1e-12);
    assert!((res.eps1eps2[(1, 1)] - -0.0932134954083656).abs() < 1e-12);
}
...
fn test_hyperdual_vec_bessel_j2_2() {
    ...
    assert!((res.eps2[1] - 0.132099570594364).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 0.240029203653306).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 1)] - 0.240029203653306).abs() < 1e-12);
