...
fn test_hyperdual_recip() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).recip();
...
fn test_hyperdual_exp() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).exp();
...
fn test_hyperdual_exp_m1() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).exp_m1();
...
fn test_hyperdual_exp2() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).exp2();
...
fn test_hyperdual_ln() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).ln();
...
fn test_hyperdual_log() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).log(4.2);
...
fn test_hyperdual_ln_1p() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).ln_1p();
...
fn test_hyperdual_log2() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).log2();
...
fn test_hyperdual_log10() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).log10();
...
fn test_hyperdual_sqrt() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sqrt();
...
fn test_hyperdual_cbrt() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).cbrt();
...
fn test_hyperdual_powf() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).powf(4.2);
...
fn test_hyperdual_powf_0() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powf(0.0);
...
fn test_hyperdual_powf_1() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powf(1.0);
...
fn test_hyperdual_powf_2() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powf(2.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
...
fn test_hyperdual_powf_3() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powf(3.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_powf_4() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powf(4.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_powi() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).powi(6);
...
fn test_hyperdual_powi_0() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powi(0);
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_powi_1() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powi(1);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0] - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps2[0] - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_powi_2() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powi(2);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)] - 2.00000000000000).abs() < 1e-12);
...
fn test_hyperdual_powi_3() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powi(3);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_powi_4() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).powi(4);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
    assert!((res.eps1eps2[(0, 0)]).abs() < 1e-12);
...
fn test_hyperdual_sin() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sin();
...
fn test_hyperdual_cos() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).cos();
...
fn test_hyperdual_tan() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).tan();
...
fn test_hyperdual_asin() {
    let res = HyperDual64::new_scalar(0.2, 1.0, 1.0, 0.0).asin();
...
fn test_hyperdual_acos() {
    let res = HyperDual64::new_scalar(0.2, 1.0, 1.0, 0.0).acos();
...
fn test_hyperdual_atan() {
    let res = HyperDual64::new_scalar(0.2, 1.0, 1.0, 0.0).atan();
...
fn test_hyperdual_sinh() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sinh();
...
fn test_hyperdual_cosh() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).cosh();
...
fn test_hyperdual_tanh() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).tanh();
...
fn test_hyperdual_asinh() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).asinh();
...
fn test_hyperdual_acosh() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).acosh();
...
fn test_hyperdual_atanh() {
    let res = HyperDual64::new_scalar(0.2, 1.0, 1.0, 0.0).atanh();
...
fn test_hyperdual_sph_j0() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sph_j0();
...
fn test_hyperdual_sph_j1() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sph_j1();
...
fn test_hyperdual_sph_j2() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).sph_j2();
...
fn test_hyperdual_bessel_j0_0() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
...
fn test_hyperdual_bessel_j1_0() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).bessel_j1();
    assert!((res.re).abs() < 1e-12);
...
fn test_hyperdual_bessel_j2_0() {
    let res = HyperDual64::new_scalar(0.0, 1.0, 1.0, 0.0).bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1[0]).abs() < 1e-12);
    assert!((res.eps2[0]).abs() < 1e-12);
...
fn test_hyperdual_bessel_j0_1() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).bessel_j0();
...
fn test_hyperdual_bessel_j1_1() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).bessel_j1();
...
fn test_hyperdual_bessel_j2_1() {
    let res = HyperDual64::new_scalar(1.2, 1.0, 1.0, 0.0).bessel_j2();
...
fn test_hyperdual_bessel_j0_2() {
    let res = HyperDual64::new_scalar(7.2, 1.0, 1.0, 0.0).bessel_j0();
...
fn test_hyperdual_bessel_j1_2() {
    let res = HyperDual64::new_scalar(7.2, 1.0, 1.0, 0.0).bessel_j1();
...
fn test_hyperdual_bessel_j2_2() {
    let res = HyperDual64::new_scalar(7.2, 1.0, 1.0, 0.0).bessel_j2();
