...
fn test_dual_vec_recip() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).recip();
...
fn test_dual_vec_exp() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).exp();
...
fn test_dual_vec_exp_m1() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).exp_m1();
...
fn test_dual_vec_exp2() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).exp2();
...
#[test]
fn test_dual_vec_ln() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).ln();
...
fn test_dual_vec_log() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).log(4.2);
...
fn test_dual_vec_ln_1p() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).ln_1p();
...
fn test_dual_vec_log2() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).log2();
...
fn test_dual_vec_log10() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).log10();
...
fn test_dual_vec_sqrt() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sqrt();
...
fn test_dual_vec_cbrt() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).cbrt();
...
fn test_dual_vec_powf() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).powf(4.2);
...
fn test_dual_vec_powf_0() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powf(0.0);
...
fn test_dual_vec_powf_1() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powf(1.0);
...
fn test_dual_vec_powf_2() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powf(2.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powf_3() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powf(3.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powf_4() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powf(4.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powi() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).powi(6);
...
fn test_dual_vec_powi_0() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powi(0);
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powi_1() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powi(1);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0] - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps[1] - 1.00000000000000).abs() < 1e-12);
}
...
fn test_dual_vec_powi_2() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powi(2);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powi_3() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powi(3);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_powi_4() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).powi(4);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_sin() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sin();
...
fn test_dual_vec_cos() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).cos();
...
fn test_dual_vec_tan() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).tan();
...
fn test_dual_vec_asin() {
    let res = DualVec64::<2>::new(0.2, SVector::from([1.0, 1.0])).asin();
...
fn test_dual_vec_acos() {
    let res = DualVec64::<2>::new(0.2, SVector::from([1.0, 1.0])).acos();
...
fn test_dual_vec_atan() {
    let res = DualVec64::<2>::new(0.2, SVector::from([1.0, 1.0])).atan();
...
fn test_dual_vec_sinh() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sinh();
...
fn test_dual_vec_cosh() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).cosh();
...
fn test_dual_vec_tanh() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).tanh();
...
fn test_dual_vec_asinh() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).asinh();
...
fn test_dual_vec_acosh() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).acosh();
...
fn test_dual_vec_atanh() {
    let res = DualVec64::<2>::new(0.2, SVector::from([1.0, 1.0])).atanh();
...
fn test_dual_vec_sph_j0() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sph_j0();
...
fn test_dual_vec_sph_j1() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sph_j1();
...
fn test_dual_vec_sph_j2() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).sph_j2();
...
fn test_dual_vec_bessel_j0_0() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_bessel_j1_0() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).bessel_j1();
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0] - 0.500000000000000).abs() < 1e-12);
    assert!((res.eps[1] - 0.500000000000000).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j2_0() {
    let res = DualVec64::<2>::new(0.0, SVector::from([1.0, 1.0])).bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
    assert!((res.eps[1]).abs() < 1e-12);
}
...
fn test_dual_vec_bessel_j0_1() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).bessel_j0();
    assert!((res.re - 0.671132744264363).abs() < 1e-12);
    assert!((res.eps[0] - -0.498289057567215).abs() < 1e-12);
    assert!((res.eps[1] - -0.498289057567215).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j1_1() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).bessel_j1();
    assert!((res.re - 0.498289057567215).abs() < 1e-12);
    assert!((res.eps[0] - 0.255891862958350).abs() < 1e-12);
    assert!((res.eps[1] - 0.255891862958350).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j2_1() {
    let res = DualVec64::<2>::new(1.2, SVector::from([1.0, 1.0])).bessel_j2();
    assert!((res.re - 0.159349018347663).abs() < 1e-12);
    assert!((res.eps[0] - 0.232707360321110).abs() < 1e-12);
    assert!((res.eps[1] - 0.232707360321110).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j0_2() {
    let res = DualVec64::<2>::new(7.2, SVector::from([1.0, 1.0])).bessel_j0();
    assert!((res.re - 0.295070691400958).abs() < 1e-12);
    assert!((res.eps[0] - -0.0543274202223671).abs() < 1e-12);
    assert!((res.eps[1] - -0.0543274202223671).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j1_2() {
    let res = DualVec64::<2>::new(7.2, SVector::from([1.0, 1.0])).bessel_j1();
    assert!((res.re - 0.0543274202223671).abs() < 1e-12);
    assert!((res.eps[0] - 0.287525216370074).abs() < 1e-12);
    assert!((res.eps[1] - 0.287525216370074).abs() < 1e-12);
}

#[test]
fn test_dual_vec_bessel_j2_2() {
    let res = DualVec64::<2>::new(7.2, SVector::from([1.0, 1.0])).bessel_j2();
