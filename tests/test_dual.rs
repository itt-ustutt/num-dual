...
fn test_dual_bessel_j0_0() {
    let res = Dual64::from(0.0).derive().bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
}
...
fn test_dual_bessel_j1_0() {
    let res = Dual64::from(0.0).derive().bessel_j1();
    assert!((res.re).abs() < 1e-12);
...
fn test_dual_bessel_j2_0() {
    let res = Dual64::from(0.0).derive().bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps[0]).abs() < 1e-12);
}
...
fn test_dual_bessel_j0_1() {
    let res = Dual64::from(1.2).derive().bessel_j0();
...
fn test_dual_bessel_j1_1() {
    let res = Dual64::from(1.2).derive().bessel_j1();
...
fn test_dual_bessel_j2_1() {
    let res = Dual64::from(1.2).derive().bessel_j2();
...
fn test_dual_bessel_j0_2() {
    let res = Dual64::from(7.2).derive().bessel_j0();
...
fn test_dual_bessel_j1_2() {
    let res = Dual64::from(7.2).derive().bessel_j1();
...
fn test_dual_bessel_j2_2() {
    let res = Dual64::from(7.2).derive().bessel_j2();
