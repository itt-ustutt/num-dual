...
#[test]
fn test_dual3_recip() {
    let res = Dual3_64::from(1.2).derivative().recip();
...
#[test]
fn test_dual3_exp() {
    let res = Dual3_64::from(1.2).derivative().exp();
...
fn test_dual3_exp_m1() {
    let res = Dual3_64::from(1.2).derivative().exp_m1();
...
#[test]
fn test_dual3_exp2() {
    let res = Dual3_64::from(1.2).derivative().exp2();
...
#[test]
fn test_dual3_ln() {
    let res = Dual3_64::from(1.2).derivative().ln();
...
#[test]
fn test_dual3_log() {
    let res = Dual3_64::from(1.2).derivative().log(4.2);
...
#[test]
fn test_dual3_ln_1p() {
    let res = Dual3_64::from(1.2).derivative().ln_1p();
...
#[test]
fn test_dual3_log2() {
    let res = Dual3_64::from(1.2).derivative().log2();
...
#[test]
fn test_dual3_log10() {
    let res = Dual3_64::from(1.2).derivative().log10();
...
#[test]
fn test_dual3_sqrt() {
    let res = Dual3_64::from(1.2).derivative().sqrt();
...
#[test]
fn test_dual3_cbrt() {
    let res = Dual3_64::from(1.2).derivative().cbrt();
...
#[test]
fn test_dual3_powf() {
    let res = Dual3_64::from(1.2).derivative().powf(4.2);
...
fn test_dual3_powf_0() {
    let res = Dual3_64::from(0.0).derivative().powf(0.0);
...
fn test_dual3_powf_1() {
    let res = Dual3_64::from(0.0).derivative().powf(1.0);
...
fn test_dual3_powf_2() {
    let res = Dual3_64::from(0.0).derivative().powf(2.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
...
fn test_dual3_powf_3() {
    let res = Dual3_64::from(0.0).derivative().powf(3.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
...
fn test_dual3_powf_4() {
    let res = Dual3_64::from(0.0).derivative().powf(4.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
    assert!((res.v3).abs() < 1e-12);
...
#[test]
fn test_dual3_powi() {
    let res = Dual3_64::from(1.2).derivative().powi(6);
...
fn test_dual3_powi_0() {
    let res = Dual3_64::from(0.0).derivative().powi(0);
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
    assert!((res.v3).abs() < 1e-12);
...
fn test_dual3_powi_1() {
    let res = Dual3_64::from(0.0).derivative().powi(1);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1 - 1.00000000000000).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
    assert!((res.v3).abs() < 1e-12);
...
fn test_dual3_powi_2() {
    let res = Dual3_64::from(0.0).derivative().powi(2);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2 - 2.00000000000000).abs() < 1e-12);
    assert!((res.v3).abs() < 1e-12);
...
fn test_dual3_powi_3() {
    let res = Dual3_64::from(0.0).derivative().powi(3);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
    assert!((res.v3 - 6.00000000000000).abs() < 1e-12);
...
fn test_dual3_powi_4() {
    let res = Dual3_64::from(0.0).derivative().powi(4);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
    assert!((res.v2).abs() < 1e-12);
    assert!((res.v3).abs() < 1e-12);
...
#[test]
fn test_dual3_sin() {
    let res = Dual3_64::from(1.2).derivative().sin();
...
#[test]
fn test_dual3_cos() {
    let res = Dual3_64::from(1.2).derivative().cos();
...
#[test]
fn test_dual3_tan() {
    let res = Dual3_64::from(1.2).derivative().tan();
...
#[test]
fn test_dual3_asin() {
    let res = Dual3_64::from(0.2).derivative().asin();
...
#[test]
fn test_dual3_acos() {
    let res = Dual3_64::from(0.2).derivative().acos();
...
#[test]
fn test_dual3_atan() {
    let res = Dual3_64::from(0.2).derivative().atan();
...
#[test]
fn test_dual3_cosh() {
    let res = Dual3_64::from(1.2).derivative().cosh();
...
#[test]
fn test_dual3_tanh() {
    let res = Dual3_64::from(1.2).derivative().tanh();
...
#[test]
fn test_dual3_asinh() {
    let res = Dual3_64::from(1.2).derivative().asinh();
...
#[test]
fn test_dual3_acosh() {
    let res = Dual3_64::from(1.2).derivative().acosh();
...
#[test]
fn test_dual3_atanh() {
    let res = Dual3_64::from(0.2).derivative().atanh();
...
fn test_dual3_sph_j0() {
    let res = Dual3_64::from(1.2).derivative().sph_j0();
...
fn test_dual3_sph_j1() {
    let res = Dual3_64::from(1.2).derivative().sph_j1();
...
fn test_dual3_sph_j2() {
    let res = Dual3_64::from(1.2).derivative().sph_j2();
...
#[test]
fn test_dual3_sph_j0_2() {
    let res = Dual3_64::from(-7.2).derivative().sph_j0();
    assert!((res.re - 0.110231647756827).abs() < 1e-12);
    assert!((res.v1 - -0.0691832870521427).abs() < 1e-12);
    assert!((res.v2 - -0.129449227493533).abs() < 1e-12);
    assert!((res.v3 - 0.0305560600071743).abs() < 1e-12);
}

#[test]
fn test_dual3_sph_j1_2() {
    let res = Dual3_64::from(-7.2).derivative().sph_j1();
    assert!((res.re - 0.0691832870521427).abs() < 1e-12);
    assert!((res.v1 - 0.129449227493533).abs() < 1e-12);
    assert!((res.v2 - -0.0305560600071743).abs() < 1e-12);
    assert!((res.v3 - -0.127207236649701).abs() < 1e-12);
}

#[test]
fn test_dual3_sph_j2_2() {
    let res = Dual3_64::from(-7.2).derivative().sph_j2();
    assert!((res.re - -0.139058017361886).abs() < 1e-12);
    assert!((res.v1 - 0.0112424464846901).abs() < 1e-12);
    assert!((res.v2 - 0.126086241227786).abs() < 1e-12);
    assert!((res.v3 - 0.0210457109861398).abs() < 1e-12);
}

#[test]
fn test_dual3_bessel_j0_0() {
    let res = Dual3_64::from(0.0).derivative().bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
...
fn test_dual3_bessel_j1_0() {
    let res = Dual3_64::from(0.0).derivative().bessel_j1();
    assert!((res.re).abs() < 1e-12);
...
fn test_dual3_bessel_j2_0() {
    let res = Dual3_64::from(0.0).derivative().bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1).abs() < 1e-12);
...
fn test_dual3_bessel_j0_1() {
    let res = Dual3_64::from(1.2).derivative().bessel_j0();
...
fn test_dual3_bessel_j1_1() {
    let res = Dual3_64::from(1.2).derivative().bessel_j1();
...
fn test_dual3_bessel_j2_1() {
    let res = Dual3_64::from(1.2).derivative().bessel_j2();
...
fn test_dual3_bessel_j0_2() {
    let res = Dual3_64::from(7.2).derivative().bessel_j0();
...
fn test_dual3_bessel_j1_2() {
    let res = Dual3_64::from(7.2).derivative().bessel_j1();
...
fn test_dual3_bessel_j2_2() {
    let res = Dual3_64::from(7.2).derivative().bessel_j2();
