...
fn test_dual2_recip() {
    ...
    assert!((res.v1.unwrap() - -0.694444444444445).abs() < 1e-12);
    assert!((res.v2.unwrap() - 1.15740740740741).abs() < 1e-12);
}
...
fn test_dual2_exp() {
    ...
    assert!((res.v1.unwrap() - 3.32011692273655).abs() < 1e-12);
    assert!((res.v2.unwrap() - 3.32011692273655).abs() < 1e-12);
}
...
fn test_dual2_exp2() {
    ...
    assert!((res.v1.unwrap() - 1.59243405216008).abs() < 1e-12);
    assert!((res.v2.unwrap() - 1.10379117348241).abs() < 1e-12);
}
...
fn test_dual2_ln() {
    ...
    assert!((res.v1.unwrap() - 0.833333333333333).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.694444444444445).abs() < 1e-12);
}
...
fn test_dual2_log() {
    ...
    assert!((res.v1.unwrap() - 0.580685888982970).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.483904907485808).abs() < 1e-12);
}
...
fn test_dual2_ln_1p() {
    ...
    assert!((res.v1.unwrap() - 0.454545454545455).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.206611570247934).abs() < 1e-12);
}
...
fn test_dual2_log2() {
    ...
    assert!((res.v1.unwrap() - 1.20224586740747).abs() < 1e-12);
    assert!((res.v2.unwrap() - -1.00187155617289).abs() < 1e-12);
}
...
fn test_dual2_log10() {
    ...
    assert!((res.v1.unwrap() - 0.361912068252710).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.301593390210592).abs() < 1e-12);
}
...
fn test_dual2_sqrt() {
    ...
    assert!((res.v1.unwrap() - 0.456435464587638).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.190181443578183).abs() < 1e-12);
}
...
fn test_dual2_cbrt() {
    ...
    assert!((res.v1.unwrap() - 0.295182935884059).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.163990519935588).abs() < 1e-12);
}
...
fn test_dual2_powf() {
    ...
    assert!((res.v1.unwrap() - 7.52712759108966).abs() < 1e-12);
    assert!((res.v2.unwrap() - 20.0723402429058).abs() < 1e-12);
}
...
fn test_dual2_powf_0() {
    ...
    assert!((res.v1.unwrap()).abs() < 1e-12);
    assert!((res.v2.unwrap()).abs() < 1e-12);
}
...
fn test_dual2_powf_1() {
    ...
    assert!((res.v1.unwrap() - 1.00000000000000).abs() < 1e-12);
    assert!((res.v2.unwrap()).abs() < 1e-12);
}
...
fn test_dual2_powf_2() {
    ...
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1.unwrap()).abs() < 1e-12);
    assert!((res.v2.unwrap() - 2.00000000000000).abs() < 1e-12);
}
...
fn test_dual2_powi() {
    ...
    assert!((res.v1.unwrap() - 14.9299200000000).abs() < 1e-12);
    assert!((res.v2.unwrap() - 62.2080000000000).abs() < 1e-12);
}
...
fn test_dual2_sin() {
    ...
    assert!((res.v1.unwrap() - 0.362357754476674).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.932039085967226).abs() < 1e-12);
}
...
fn test_dual2_cos() {
    ...
    assert!((res.v1.unwrap() - -0.932039085967226).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.362357754476674).abs() < 1e-12);
}
...
fn test_dual2_tan() {
    ...
    assert!((res.v1.unwrap() - 7.61596396720705).abs() < 1e-12);
    assert!((res.v2.unwrap() - 39.1788281446144).abs() < 1e-12);
}
...
fn test_dual2_asin() {
    ...
    assert!((res.v1.unwrap() - 1.02062072615966).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.212629317949929).abs() < 1e-12);
}
...
fn test_dual2_atan() {
    ...
    assert!((res.v1.unwrap() - 0.961538461538462).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.369822485207101).abs() < 1e-12);
}
...
fn test_dual2_sinh() {
    ...
    assert!((res.v1.unwrap() - 1.81065556732437).abs() < 1e-12);
    assert!((res.v2.unwrap() - 1.50946135541217).abs() < 1e-12);
}
...
fn test_dual2_cosh() {
    ...
    assert!((res.v1.unwrap() - 1.50946135541217).abs() < 1e-12);
    assert!((res.v2.unwrap() - 1.81065556732437).abs() < 1e-12);
}
...
fn test_dual2_tanh() {
    ...
    assert!((res.v1.unwrap() - 0.305019996207409).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.508562650138273).abs() < 1e-12);
}
...
fn test_dual2_asinh() {
    ...
    assert!((res.v1.unwrap() - 0.640184399664480).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.314844786720236).abs() < 1e-12);
}
...
fn test_dual2_acosh() {
    ...
    assert!((res.v1.unwrap() - 1.50755672288882).abs() < 1e-12);
    assert!((res.v2.unwrap() - -4.11151833515132).abs() < 1e-12);
}
...
fn test_dual2_atanh() {
    ...
    assert!((res.v1.unwrap() - 1.04166666666667).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.434027777777778).abs() < 1e-12);
}
...
fn test_dual2_sph_j0() {
    ...
    assert!((res.v1.unwrap() - -0.345284569857790).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.201224955209705).abs() < 1e-12);
}
...
fn test_dual2_sph_j1() {
    ...
    assert!((res.v1.unwrap() - 0.201224955209705).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.201097592627034).abs() < 1e-12);
}
...
fn test_dual2_sph_j2() {
    ...
    assert!((res.v1.unwrap() - 0.129004104011656).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.0589484167190109).abs() < 1e-12);
}
...
fn test_dual2_bessel_j0_0() {
    ...
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.v1.unwrap()).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.500000000000000).abs() < 1e-12);
}
...
fn test_dual2_bessel_j1_0() {
    ...
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1.unwrap() - 0.500000000000000).abs() < 1e-12);
    assert!((res.v2.unwrap()).abs() < 1e-12);
}
...
fn test_dual2_bessel_j2_0() {
    ...
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1.unwrap()).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.250000000000000).abs() < 1e-12);
}
...
fn test_dual2_bessel_j0_1() {
    ...
    assert!((res.v1.unwrap() - -0.498289057567215).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.255891862958350).abs() < 1e-12);
}
...
fn test_dual2_bessel_j1_1() {
    ...
    assert!((res.v1.unwrap() - 0.255891862958350).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.365498208944163).abs() < 1e-12);
}
...
fn test_dual2_bessel_j2_1() {
    ...
    assert!((res.v1.unwrap() - 0.232707360321110).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.0893643434615870).abs() < 1e-12);
}
...
fn test_dual2_bessel_j0_2() {
    ...
    assert!((res.v1.unwrap() - -0.0543274202223671).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.287525216370074).abs() < 1e-12);
}
...
fn test_dual2_bessel_j1_2() {
    ...
    assert!((res.v1.unwrap() - 0.287525216370074).abs() < 1e-12);
    assert!((res.v2.unwrap() - -0.0932134954083656).abs() < 1e-12);
}
...
fn test_dual2_bessel_j2_2() {
    ...
    assert!((res.v1.unwrap() - 0.132099570594364).abs() < 1e-12);
    assert!((res.v2.unwrap() - 0.240029203653306).abs() < 1e-12);
}
