...
#[test]
fn test_dual2_recip() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).recip();
...
#[test]
fn test_dual2_exp() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).exp();
...
fn test_dual2_exp_m1() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).exp_m1();
...
#[test]
fn test_dual2_exp2() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).exp2();
...
#[test]
fn test_dual2_ln() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).ln();
...
#[test]
fn test_dual2_log() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).log(4.2);
...
#[test]
fn test_dual2_ln_1p() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).ln_1p();
...
#[test]
fn test_dual2_log2() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).log2();
...
#[test]
fn test_dual2_log10() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).log10();
...
#[test]
fn test_dual2_sqrt() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sqrt();
...
#[test]
fn test_dual2_cbrt() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).cbrt();
...
#[test]
fn test_dual2_powf() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).powf(4.2);
...
fn test_dual2_powf_0() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powf(0.0);
...
fn test_dual2_powf_1() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powf(1.0);
...
fn test_dual2_powf_2() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powf(2.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
...
fn test_dual2_powf_3() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powf(3.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
fn test_dual2_powf_4() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powf(4.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
#[test]
fn test_dual2_powi() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).powi(6);
...
fn test_dual2_powi_0() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powi(0);
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
fn test_dual2_powi_1() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powi(1);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0] - 1.00000000000000).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
fn test_dual2_powi_2() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powi(2);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)] - 2.00000000000000).abs() < 1e-12);
}
...
fn test_dual2_powi_3() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powi(3);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
fn test_dual2_powi_4() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).powi(4);
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
    assert!((res.v2[(0, 0)]).abs() < 1e-12);
}
...
#[test]
fn test_dual2_sin() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sin();
...
#[test]
fn test_dual2_cos() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).cos();
...
#[test]
fn test_dual2_tan() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).tan();
...
#[test]
fn test_dual2_asin() {
    let res = Dual2_64::new_scalar(0.2, 1.0, 0.0).asin();
...
#[test]
fn test_dual2_acos() {
    let res = Dual2_64::new_scalar(0.2, 1.0, 0.0).acos();
...
#[test]
fn test_dual2_atan() {
    let res = Dual2_64::new_scalar(0.2, 1.0, 0.0).atan();
...
#[test]
fn test_dual2_sinh() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sinh();
...
#[test]
fn test_dual2_cosh() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).cosh();
...
#[test]
fn test_dual2_tanh() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).tanh();
...
#[test]
fn test_dual2_asinh() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).asinh();
...
#[test]
fn test_dual2_acosh() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).acosh();
...
#[test]
fn test_dual2_atanh() {
    let res = Dual2_64::new_scalar(0.2, 1.0, 0.0).atanh();
...
fn test_dual2_sph_j0() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sph_j0();
...
fn test_dual2_sph_j1() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sph_j1();
...
fn test_dual2_sph_j2() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).sph_j2();
...
fn test_dual2_bessel_j0_0() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
...
fn test_dual2_bessel_j1_0() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).bessel_j1();
    assert!((res.re).abs() < 1e-12);
...
fn test_dual2_bessel_j2_0() {
    let res = Dual2_64::new_scalar(0.0, 1.0, 0.0).bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.v1[0]).abs() < 1e-12);
...
fn test_dual2_bessel_j0_1() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).bessel_j0();
...
fn test_dual2_bessel_j1_1() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).bessel_j1();
...
fn test_dual2_bessel_j2_1() {
    let res = Dual2_64::new_scalar(1.2, 1.0, 0.0).bessel_j2();
...
fn test_dual2_bessel_j0_2() {
    let res = Dual2_64::new_scalar(7.2, 1.0, 0.0).bessel_j0();
...
fn test_dual2_bessel_j1_2() {
    let res = Dual2_64::new_scalar(7.2, 1.0, 0.0).bessel_j1();
...
fn test_dual2_bessel_j2_2() {
    let res = Dual2_64::new_scalar(7.2, 1.0, 0.0).bessel_j2();
