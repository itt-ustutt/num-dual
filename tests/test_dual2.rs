...
#[test]
fn test_dual2_sph_j0_2() {
    let res = Dual2_64::from(-7.2).derivative().sph_j0();
...
#[test]
fn test_dual2_sph_j1_2() {
    let res = Dual2_64::from(-7.2).derivative().sph_j1();
...
#[test]
fn test_dual2_sph_j2_2() {
    let res = Dual2_64::from(-7.2).derivative().sph_j2();
