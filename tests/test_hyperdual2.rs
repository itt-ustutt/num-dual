...
#[test]
fn test_hyperdual2_recip() {
    let res = HyperDual2_64::from(1.2)
        .derive1()
        .derive2()
        .derive3()
        .recip();
...
#[test]
fn test_hyperdual2_exp() {
    let res = HyperDual2_64::from(1.2).derive1().derive2().derive3().exp();
...
#[test]
fn test_hyperdual2_ln() {
    let res = HyperDual2_64::from(1.2).derive1().derive2().derive3().ln();
...
#[test]
fn test_hyperdual2_powf_0() {
    let res = HyperDual2_64::from(0.0)
        .derive1()
        .derive2()
        .derive3()
        .powf(0.0);
...
#[test]
fn test_hyperdual2_sin() {
    let res = HyperDual2_64::from(1.2).derive1().derive2().derive3().sin();
...
#[test]
fn test_hyperdual2_cos() {
    let res = HyperDual2_64::from(1.2).derive1().derive2().derive3().cos();
...
#[test]
fn test_hyperdual2_tan() {
    let res = HyperDual2_64::from(1.2).derive1().derive2().derive3().tan();
    ...
    println!(
        "test_hyperdual2_tan:   res.eps1eps2eps3 = {}",
        res.eps1eps2eps3
    );
...
#[test]
fn test_hyperdual2_asin() {
    let res = HyperDual2_64::from(0.2)
        .derive1()
        .derive2()
        .derive3()
        .asin();
...
#[test]
fn test_hyperdual2_bessel_j0_0() {
    let res = HyperDual2_64::from(0.0)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j1_0() {
    let res = HyperDual2_64::from(0.0)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j2_0() {
    let res = HyperDual2_64::from(0.0)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j0_1() {
    let res = HyperDual2_64::from(1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j1_1() {
    let res = HyperDual2_64::from(1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j2_1() {
    let res = HyperDual2_64::from(1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j0_2() {
    let res = HyperDual2_64::from(7.2)
        .derive1()
        .derive2()
        .derive3()
        .bessel_j0();
    ...
    println!(
        "test_hyperdual2_bessel_j0_2:   res.eps1eps2eps3 = {}",
        res.eps1eps2eps3
    );
...
#[test]
fn test_hyperdual2_bessel_j1_2() {
    let res = HyperDual2_64::from(7.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j2_2() {
    let res = HyperDual2_64::from(7.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j0_3() {
    let res = HyperDual2_64::from(-1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j1_3() {
    let res = HyperDual2_64::from(-1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j2_3() {
    let res = HyperDual2_64::from(-1.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j0_4() {
    let res = HyperDual2_64::from(-7.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j1_4() {
    let res = HyperDual2_64::from(-7.2)
        .derive1()
        .derive2()
        .derive3()
...
#[test]
fn test_hyperdual2_bessel_j2_4() {
    let res = HyperDual2_64::from(-7.2)
        .derive1()
        .derive2()
        .derive3()
