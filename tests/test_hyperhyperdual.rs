...
fn test_hyperhyperdual_recip() {
    let res = HyperHyperDual64::from(1.2).derivative().recip();
...
fn test_hyperhyperdual_exp() {
    let res = HyperHyperDual64::from(1.2).derivative().exp();
...
fn test_hyperhyperdual_exp_m1() {
    let res = HyperHyperDual64::from(1.2).derivative().exp_m1();
...
fn test_hyperhyperdual_exp2() {
    let res = HyperHyperDual64::from(1.2).derivative().exp2();
...
fn test_hyperhyperdual_ln() {
    let res = HyperHyperDual64::from(1.2).derivative().ln();
...
fn test_hyperhyperdual_log() {
    let res = HyperHyperDual64::from(1.2).derivative().log(4.2);
...
fn test_hyperhyperdual_ln_1p() {
    let res = HyperHyperDual64::from(1.2).derivative().ln_1p();
...
fn test_hyperhyperdual_log2() {
    let res = HyperHyperDual64::from(1.2).derivative().log2();
...
fn test_hyperhyperdual_log10() {
    let res = HyperHyperDual64::from(1.2).derivative().log10();
...
fn test_hyperhyperdual_sqrt() {
    let res = HyperHyperDual64::from(1.2).derivative().sqrt();
...
fn test_hyperhyperdual_cbrt() {
    let res = HyperHyperDual64::from(1.2).derivative().cbrt();
...
fn test_hyperhyperdual_powf() {
    let res = HyperHyperDual64::from(1.2).derivative().powf(4.2);
...
fn test_hyperhyperdual_powf_0() {
    let res = HyperHyperDual64::from(0.0).derivative().powf(0.0);
...
fn test_hyperhyperdual_powf_1() {
    let res = HyperHyperDual64::from(0.0).derivative().powf(1.0);
...
fn test_hyperhyperdual_powf_2() {
    let res = HyperHyperDual64::from(0.0).derivative().powf(2.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powf_3() {
    let res = HyperHyperDual64::from(0.0).derivative().powf(3.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powf_4() {
    let res = HyperHyperDual64::from(0.0).derivative().powf(4.0);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powi() {
    let res = HyperHyperDual64::from(1.2).derivative().powi(6);
...
fn test_hyperhyperdual_powi_0() {
    let res = HyperHyperDual64::from(0.0).derivative().powi(0);
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powi_1() {
    let res = HyperHyperDual64::from(0.0).derivative().powi(1);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1 - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps2 - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps3 - 1.00000000000000).abs() < 1e-12);
...
fn test_hyperhyperdual_powi_2() {
    let res = HyperHyperDual64::from(0.0).derivative().powi(2);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powi_3() {
    let res = HyperHyperDual64::from(0.0).derivative().powi(3);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_powi_4() {
    let res = HyperHyperDual64::from(0.0).derivative().powi(4);
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_sin() {
    let res = HyperHyperDual64::from(1.2).derivative().sin();
...
fn test_hyperhyperdual_cos() {
    let res = HyperHyperDual64::from(1.2).derivative().cos();
...
fn test_hyperhyperdual_tan() {
    let res = HyperHyperDual64::from(1.2).derivative().tan();
...
fn test_hyperhyperdual_asin() {
    let res = HyperHyperDual64::from(0.2).derivative().asin();
...
fn test_hyperhyperdual_acos() {
    let res = HyperHyperDual64::from(0.2).derivative().acos();
...
fn test_hyperhyperdual_atan() {
    let res = HyperHyperDual64::from(0.2).derivative().atan();
...
fn test_hyperhyperdual_sinh() {
    let res = HyperHyperDual64::from(1.2).derivative().sinh();
...
fn test_hyperhyperdual_cosh() {
    let res = HyperHyperDual64::from(1.2).derivative().cosh();
...
fn test_hyperhyperdual_tanh() {
    let res = HyperHyperDual64::from(1.2).derivative().tanh();
...
fn test_hyperhyperdual_asinh() {
    let res = HyperHyperDual64::from(1.2).derivative().asinh();
...
fn test_hyperhyperdual_acosh() {
    let res = HyperHyperDual64::from(1.2).derivative().acosh();
...
fn test_hyperhyperdual_atanh() {
    let res = HyperHyperDual64::from(0.2).derivative().atanh();
...
fn test_hyperhyperdual_sph_j0() {
    let res = HyperHyperDual64::from(1.2).derivative().sph_j0();
...
fn test_hyperhyperdual_sph_j1() {
    let res = HyperHyperDual64::from(1.2).derivative().sph_j1();
...
fn test_hyperhyperdual_sph_j2() {
    let res = HyperHyperDual64::from(1.2).derivative().sph_j2();
...
fn test_hyperhyperdual_bessel_j0_0() {
    let res = HyperHyperDual64::from(0.0).derivative().bessel_j0();
    assert!((res.re - 1.00000000000000).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_bessel_j1_0() {
    let res = HyperHyperDual64::from(0.0).derivative().bessel_j1();
    assert!((res.re).abs() < 1e-12);
...
fn test_hyperhyperdual_bessel_j2_0() {
    let res = HyperHyperDual64::from(0.0).derivative().bessel_j2();
    assert!((res.re).abs() < 1e-12);
    assert!((res.eps1).abs() < 1e-12);
    assert!((res.eps2).abs() < 1e-12);
    assert!((res.eps3).abs() < 1e-12);
...
fn test_hyperhyperdual_bessel_j0_1() {
    let res = HyperHyperDual64::from(1.2).derivative().bessel_j0();
...
fn test_hyperhyperdual_bessel_j1_1() {
    let res = HyperHyperDual64::from(1.2).derivative().bessel_j1();
...
fn test_hyperhyperdual_bessel_j2_1() {
    let res = HyperHyperDual64::from(1.2).derivative().bessel_j2();
...
fn test_hyperhyperdual_bessel_j0_2() {
    let res = HyperHyperDual64::from(7.2).derivative().bessel_j0();
...
fn test_hyperhyperdual_bessel_j1_2() {
    let res = HyperHyperDual64::from(7.2).derivative().bessel_j1();
...
fn test_hyperhyperdual_bessel_j2_2() {
    let res = HyperHyperDual64::from(7.2).derivative().bessel_j2();
